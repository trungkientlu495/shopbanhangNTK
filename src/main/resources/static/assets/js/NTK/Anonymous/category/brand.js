function searchbyBrand() {
	if ((document.getElementById("unisex").checked || document.getElementById("tlu").checked || document.getElementById("yody").checked)
	&&
	...
	!(document.getElementById("hoatoc").checked || document.getElementById("nhanh").checked || document.getElementById("tietkiem").checked)
		...
		$.ajax({
			type: "POST",
			url: "/Anonymous/searchbyBrand",
			data: { search: nameValue, unisex: unisex, tlu: tlu, yody: yody }, // Truyền tham số 'data' như đã định nghĩa trong phương thức 'searchProducts'
